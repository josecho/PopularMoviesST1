...
public class TestUriMatcher extends AndroidTestCase {
    ...
    private static final Uri TEST_POPULAR_MOVIE_DIR = PopularMovieContract.PopularMovieEntry.CONTENT_URI;
    ...
    public void testUriMatcher() {
        UriMatcher testMatcher = PopularMovieProvider.buildUriMatcher();
        ...
        assertEquals("Error: The VIDEO was matched incorrectly.",
                testMatcher.match(TEST_VIDEOS_DIR), PopularMovieProvider.VIDEO);
